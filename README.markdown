...
- [<span class="toc-section-number">5</span> Further information][]
  ...
  [<span class="toc-section-number">1.2</span> How is FeenoX different?]:
    #how-is-feenox-different
  [<span class="toc-section-number">1.3</span> What is FeenoX anyway?]: #what-is-feenox-anyway
  ...
  [<span class="toc-section-number">3.1</span> Test suite]: #test-suite
  [<span class="toc-section-number">4</span> Licensing]: #sec:licensing
  [<span class="toc-section-number">4.1</span> Contributing]: #contributing
...
terms][Licensing]. See below for contribution guidelines.
...
See the [examples page][] for examples. The FeenoX examples are divided
by the type of problem they solve:
...
Contributions under the terms of the GPLv3+ are welcome, especially new
...
1.  Read the [compilation][] and [programming][] guides.
