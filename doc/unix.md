...
# Rule of Modularity {#sec:modularity}
...
# Rule of Composition {#sec:composition}
...
# Rule of Separation {#sec:separation}
...
# Rule of Simplicity {#sec:simplicity}
...
# Rule of Parsimony {#sec:parsimony}
...
# Rule of Transparency {#sec:transparency}
...
# Rule of Robustness {#sec:robustness}
...
# Rule of Representation {#sec:representation}
...
# Rule of Least Surprise {#sec:least-surprise}
...
# Rule of Generation {#sec:generation}
...
# Rule of Optimization {#sec:optimization}
...
# Rule of Diversity {#sec:diversity}
...
# Rule of Extensibility {#sec:extensibility}
