...
Printf("ffmpeg -y -framerate 10 -f image2 -i maze-tran-bu-%%03d.png maze-tran-bu.mp4");
Printf("ffmpeg -y -framerate 10 -f image2 -i maze-tran-bu-%%03d.png maze-tran-bu.gif");
Exit;
