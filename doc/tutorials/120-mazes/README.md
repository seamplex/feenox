...
We will...
 ...
 3. solve $\nabla^2 \phi(x,y) = 0$ subject to $\phi(x,y) = 1$ at the inlet and $\phi(x,y) = 0$ at the outlet (with homogeneous Neumann boundary conditions everywhere else) using [FeenoX](https://www.seamplex.com/feenox/):
