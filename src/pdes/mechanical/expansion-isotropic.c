...
int feenox_problem_build_compute_mechanical_et_isotropic (const double *x, material_t *material) {
...
int feenox_stress_thermal_isotropic (const double *x, material_t *material, double *sigmat_x, double *sigmat_y, double *sigmat_z) {
