...
extern int feenox_problem_bc_set_laplace_phi(bc_data_t *this, element_t *e, size_t j_global);
extern int feenox_problem_bc_set_laplace_derivative(bc_data_t *this, element_t *e, unsigned int v);
