...
extern int feenox_problem_bc_set_thermal_temperature(bc_data_t *this, element_t *e, size_t j_global);

extern int feenox_problem_bc_set_thermal_heatflux(bc_data_t *this, element_t *e,  unsigned int v);
extern int feenox_problem_bc_set_thermal_convection(bc_data_t *this, element_t *e,  unsigned int v);
