...
int feenox_problem_build_elemental_objects_allocate(element_t *this) {
  ...
  if (feenox.pde.has_stiffness) {
    feenox_check_alloc(feenox.pde.Ki = feenox_lowlevel_matrix_calloc(feenox.pde.elemental_size, feenox.pde.elemental_size));
  }  
  if (feenox.pde.has_mass) {
    feenox_check_alloc(feenox.pde.Mi = feenox_lowlevel_matrix_calloc(feenox.pde.elemental_size, feenox.pde.elemental_size));
  }
  if (feenox.pde.has_jacobian_K) {
    feenox_check_alloc(feenox.pde.JKi = feenox_lowlevel_matrix_calloc(feenox.pde.elemental_size, feenox.pde.elemental_size));
  }
  if (feenox.pde.has_jacobian_b) {
    feenox_check_alloc(feenox.pde.Jbi = feenox_lowlevel_matrix_calloc(feenox.pde.elemental_size, feenox.pde.elemental_size));
  }
  if (feenox.pde.has_rhs) {
    feenox_check_alloc(feenox.pde.bi = feenox_lowlevel_vector_calloc(feenox.pde.elemental_size));
  }
...
int feenox_problem_build_elemental_objects_free(void) {
  ...
  if (feenox.pde.n_local_nodes != 0 && feenox.pde.elemental_size != 0) {
    feenox_lowlevel_matrix_free(&feenox.pde.Ki);
    feenox_lowlevel_matrix_free(&feenox.pde.Mi);
    feenox_lowlevel_vector_free(&feenox.pde.bi);
  }
...
int feenox_problem_build_element_volumetric(element_t *this) {
  ...
  if (feenox.pde.has_mass) {
    feenox_lowlevel_matrix_set_zero(feenox.pde.Mi);
  }
  if (feenox.pde.has_jacobian_K) {
    feenox_lowlevel_matrix_set_zero(feenox.pde.JKi);
  }
  if (feenox.pde.has_jacobian_b) {
  ...
  if (feenox.pde.has_stiffness)  {
    petsc_call(MatSetValues(feenox.pde.K, feenox.pde.elemental_size, this->l, feenox.pde.elemental_size, this->l, feenox_lowlevel_matrix_get_ptr(feenox.pde.Ki, 0, 0), ADD_VALUES));
  }  
  if (feenox.pde.has_mass)  {
    petsc_call(MatSetValues(feenox.pde.M, feenox.pde.elemental_size, this->l, feenox.pde.elemental_size, this->l, feenox_lowlevel_matrix_get_ptr(feenox.pde.Mi, 0, 0), ADD_VALUES));
  }
  if (feenox.pde.has_jacobian_K) {
    petsc_call(MatSetValues(feenox.pde.JK, feenox.pde.elemental_size, this->l, feenox.pde.elemental_size, this->l, feenox_lowlevel_matrix_get_ptr(feenox.pde.JKi, 0, 0), ADD_VALUES));
  }
  if (feenox.pde.has_jacobian_b) {
    petsc_call(MatSetValues(feenox.pde.Jb, feenox.pde.elemental_size, this->l, feenox.pde.elemental_size, this->l, feenox_lowlevel_matrix_get_ptr(feenox.pde.Jbi, 0, 0), ADD_VALUES));
  }
  if (feenox.pde.has_rhs) {
    petsc_call(VecSetValues(feenox.pde.b, feenox.pde.elemental_size, this->l, feenox_lowlevel_vector_get_ptr(feenox.pde.bi, 0), ADD_VALUES));
  }
...
int feenox_problem_build_element_natural_bc(element_t *this, bc_data_t *bc_data) {
  ...
  if (bc_data->fills_matrix) {
    petsc_call(MatSetValues(feenox.pde.K, feenox.pde.elemental_size, this->l,
                                          feenox.pde.elemental_size, this->l, feenox_lowlevel_matrix_get_ptr(feenox.pde.Ki, 0, 0), ADD_VALUES));
  }
/*
  if (feenox.pde.has_jacobian_K) {
    petsc_call(MatSetValues(feenox.pde.JK, feenox.pde.elemental_size, this->l, feenox.pde.elemental_size, this->l, feenox_lowlevel_matrix_get_ptr(feenox.pde.JKi, 0, 0), ADD_VALUES));
