...
*/ 
  ...
  feenox_call(feenox_mesh_gauss_init_quad9(element_type, &element_type->gauss[integration_full]));
  ...
  feenox_call(feenox_mesh_gauss_init_quad4(element_type, &element_type->gauss[integration_reduced]));
