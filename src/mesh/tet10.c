...
*/     
  ...
  r[2] = 0.5*(c+c);
  for (v = 0; v < 4; v++) {
    feenox_lowlevel_matrix_set(element_type->gauss[integration_full].extrap, 4, v, feenox_mesh_tet4_h(v, r));
  }
  ...
  r[2] = 0.5*(c+c);
  for (v = 0; v < 4; v++) {
    feenox_lowlevel_matrix_set(element_type->gauss[integration_full].extrap, 5, v, feenox_mesh_tet4_h(v, r));
  }
  ...
  r[2] = 0.5*(c+c);
  for (v = 0; v < 4; v++) {
    feenox_lowlevel_matrix_set(element_type->gauss[integration_full].extrap, 6, v, feenox_mesh_tet4_h(v, r));
  }
  ...
  r[2] = 0.5*(c+d);
  for (v = 0; v < 4; v++) {
    feenox_lowlevel_matrix_set(element_type->gauss[integration_full].extrap, 7, v, feenox_mesh_tet4_h(v, r));
  }
  ...
  r[2] = 0.5*(c+d);
  for (v = 0; v < 4; v++) {
    feenox_lowlevel_matrix_set(element_type->gauss[integration_full].extrap, 8, v, feenox_mesh_tet4_h(v, r));
  }
  ...
  r[2] = 0.5*(c+d);
  for (v = 0; v < 4; v++) {
    feenox_lowlevel_matrix_set(element_type->gauss[integration_full].extrap, 9, v, feenox_mesh_tet4_h(v, r));
  }
