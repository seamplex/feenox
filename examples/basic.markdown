...
- [<span class="toc-section-number">1</span> Hello World (and
  Universe)!][]
- [<span class="toc-section-number">2</span> The logistic map][]
- [<span class="toc-section-number">3</span> The Fibonacci sequence][]
  - [<span class="toc-section-number">3.1</span> Using the closed-form
    formula as a function][]
  - [<span class="toc-section-number">3.2</span> Using a vector][]
  - [<span class="toc-section-number">3.3</span> Solving an iterative
    problem][]
- [<span class="toc-section-number">4</span> Computing the derivative of
  a function as a UNIX filter][]
- [<span class="toc-section-number">5</span> On the evaluation of
  thermal expansion coefficients][]

  [<span class="toc-section-number">1</span> Hello World (and Universe)!]:
    #hello-world-and-universe
  [<span class="toc-section-number">2</span> The logistic map]: #the-logistic-map
  [<span class="toc-section-number">3</span> The Fibonacci sequence]: #the-fibonacci-sequence
  [<span class="toc-section-number">3.1</span> Using the closed-form formula as a function]:
    #using-the-closed-form-formula-as-a-function
  [<span class="toc-section-number">3.2</span> Using a vector]: #using-a-vector
  [<span class="toc-section-number">3.3</span> Solving an iterative problem]:
    #solving-an-iterative-problem
  [<span class="toc-section-number">4</span> Computing the derivative of a function as a UNIX filter]:
    #computing-the-derivative-of-a-function-as-a-unix-filter
  [<span class="toc-section-number">5</span> On the evaluation of thermal expansion coefficients]:
