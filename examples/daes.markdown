...
- [<span class="toc-section-number">5</span> Effect of top spin in a
  tennis ball]
  ...
  [<span class="toc-section-number">5</span> Effect of top spin in a tennis ball]:
...
This input file solves for the $`x(t)`$-$`y(t)`$ position of a tennis
ball taking into account vertical, horizontal and rotation force and
torque balances. Without arguments, it computes the trajectory for a
base set of parameters. With two arguments, the first one chooses which
parameter to disturb and the second gives a signed fraction with the
disturbance.
...
<figure>
<img src="tennis-top.svg"
alt="Effect of top spin in the trajectory of a tennis ball" />
<figcaption aria-hidden="true">Effect of top spin in the trajectory of a
tennis ball</figcaption>
</figure>
